;*****************start of the zip_OS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to zipOS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO zipOS ************', 0x00 
	...
	wel7 db ' zipOS From K.V.R.P Edirisinghe - SE/2019/055', 0x00
	...
	strPrompt		db	"zip_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"zip", 0x00	;OS details
